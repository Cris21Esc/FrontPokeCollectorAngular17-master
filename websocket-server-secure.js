...
const options = {
  key: fs.readFileSync('/etc/ssl/private/apache-selfsigned.key'),  // Ruta a tu clave privada
  cert: fs.readFileSync('/etc/ssl/certs/apache-selfsigned.crt')  // Ruta a tu certificado
};
